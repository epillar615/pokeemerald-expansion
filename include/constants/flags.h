...
#define FLAG_EXP_SHARE_KEY  0x265 // Unused Flag
...
#define FLAG_ITEM_MAGMA_HIDEOUT_3F_3R_CAMERUPTITE                   0x466 // Unused Flag, leftover from the Ruby Magma hideout
#define FLAG_ITEM_AQUA_HIDEOUT_B2F_SHARPEDONITE                     0x467 // Unused Flag, leftover from the Ruby Magma hideout
...
// Sidequest Flags
#define FLAG_HIDE_RUSTBORO_CITY_ROXANNE                             0x493 // Unused Flag
