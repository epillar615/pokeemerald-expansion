...
const u8 gText_SideQuestDesc_4[] = _("Go battle your new rival!");
...
const u8 gText_SideQuestDoneDesc_4[] = _("You defeated your rival...\n...this time.");
...
const u8 gText_SideQuestMap4[] = _("Route 103");
