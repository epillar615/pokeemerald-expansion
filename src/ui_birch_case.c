...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_TOP_THIRD]        = {SPECIES_RALTS, 5},
    [BALL_TOP_FOURTH]       = {SPECIES_EEVEE, 5},
    [BALL_MIDDLE_THIRD]     = {SPECIES_MAREEP, 5},

    [BALL_MIDDLE_SECOND]    = {SPECIES_VENIPEDE, 5},
    [BALL_BOTTOM_FIRST]     = {SPECIES_SANDILE, 5},
    [BALL_BOTTOM_SECOND]    = {SPECIES_ROOKIDEE, 5},
};
